 ...
 * The GPIO pin number must be passed to the overleaded class constructor
 */
...
public:
  ...
  int export_gpio(); // export GPIO
  int unexport_gpio(); // unexport GPIO
  int setdir_gpio(string dir); // Set GPIO Direction
  int setval_gpio(string dir); // Set GPIO Value (output pins)
